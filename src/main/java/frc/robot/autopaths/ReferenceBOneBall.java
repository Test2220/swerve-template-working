...
public class ReferenceBOneBall extends SequentialCommandGroup {
    ...
    public ReferenceBOneBall(Intake intake, Drivetrain drivetrain, Shooter shooter, Conveyor conveyor) {
        addCommands(
            ...
            new GoToCommand(drivetrain, GeomUtil.getRobotCoordinate(FieldConstants.oneBallTaxiPoseFromReferencPose2d(FieldConstants.referenceBRobotCenter)))
