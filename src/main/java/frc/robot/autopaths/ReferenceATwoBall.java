...
public class ReferenceATwoBall extends SequentialCommandGroup {
    ...
    public ReferenceATwoBall(Intake intake, Drivetrain drivetrain, Shooter shooter, Conveyor conveyor) {
        addCommands(
            ...
            new GoToCommand(drivetrain, GeomUtil.getRobotCoordinate(GeomUtil.poseToGetCargo(FieldConstants.referenceARobotCenter.getTranslation(), FieldConstants.cargoB.getTranslation()))).raceWith(new RunIntake(intake, false)),
