...
// public class ReferenceBThreeBall extends SequentialCommandGroup {
    
//     public ReferenceBThreeBall(Intake intake, Drivetrain drivetrain, Shooter shooter, Conveyor conveyor) {
//         addCommands(
