...
import frc.robot.subsystems.drivetrain.PathFinder;
...
public class PathCommand extends CommandBase {
   ...
   */
  public PathCommand(Drivetrain drivetrain, String pathString) {
  ...
  public void initialize() {
    ...
    endPos = new PathFinder(path, drivetrain.getPosition());
  }
