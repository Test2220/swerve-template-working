...
public class RobotContainer {
  ...
  private void configureButtonBindings() {
    ...
    new Button(() -> manipulatorController.getRightTriggerAxis() > 0.4)
        .whileHeld(new RunShooter(shooter, conveyor));

    new Button(() -> manipulatorController.getLeftTriggerAxis() > 0.4)
        .whileHeld(new RunIntake(intake));

    new Button(manipulatorController::getLeftBumper).whileHeld(new RunClimber(climber, false));

    new Button(manipulatorController::getRightBumper).whileHeld(new RunClimber(climber, true));
